...
import Notifications from "@/components/Notifications/NotificationSection";
    ...
    const fetchItems = async () => {
      try {
        const response = await axios.get(
          "https://run.mocky.io/v3/5f00eda3-787d-4025-93dd-28ff14b7b62f"
        );
